...
WebUI.click(findTestObject('JM_8918/Page_JM Control Centre/div_Region_v-filterselect-butt'))

WebUI.click(findTestObject('FSM1/Control Centre/Create EMI Inspection New/Page_JM Control Centre/span_West'))

WebUI.click(findTestObject('JM_8918/Page_JM Control Centre/div_Inspection Type_v-filterse'))
...
WebUI.click(findTestObject('JM_8918/Page_JM Control Centre/Page_JM Control Centre/div_Business Type_v-filtersele'))
