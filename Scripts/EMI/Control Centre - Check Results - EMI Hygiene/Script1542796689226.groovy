...
WebUI.verifyElementPresent(findTestObject('FSM1/Complete ABP Inspection/Check Results/03a/Page_JM Control Centre/div_Attachments_EMH09'), 
    5)

WebUI.verifyElementPresent(findTestObject('FSM1/Complete ABP Inspection/Check Results/03a/Page_JM Control Centre/div_Attachments_EMR04H'), 
    5)
