...
WebUI.click(findTestObject('Object Repository/FSM1/NCP/Complete Inspection/Layers/Page_JClient/input_Incident reference when'))

WebUI.setText(findTestObject('Object Repository/FSM1/NCP/Complete Inspection/Layers/Page_JClient/input_Year_gwt-DoubleBox GKH2E'), 
    '2018')

WebUI.setText(findTestObject('Object Repository/FSM1/NCP/Complete Inspection/Layers/Page_JClient/input_APHA (Field Services) Of'), 
    '12')

WebUI.setText(findTestObject('Object Repository/FSM1/NCP/Complete Inspection/Layers/Page_JClient/input_Sequential No._gwt-Doubl'), 
    '12')

WebUI.setText(findTestObject('Object Repository/FSM1/NCP/Complete Inspection/Layers/Page_JClient/input_Total No. of flocks on p'), 
    '5')

WebUI.setText(findTestObject('Object Repository/FSM1/NCP/Complete Inspection/Layers/Page_JClient/input_No. of birds on premises'), 
    '50')

WebUI.click(findTestObject('Object Repository/FSM1/NCP/Complete Inspection/Layers/Page_JClient/input_Barn_gwt-uid-133'))
