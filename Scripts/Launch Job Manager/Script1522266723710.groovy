...
WebUI.setText(findTestObject('FSM1/Launch Application/Page_JClient/input_gwt-TextBox GKH2EKQBNHC'), Username)

WebUI.setText(findTestObject('FSM1/Launch Application/Page_JClient/input_gwt-PasswordTextBox GKH2'), Password)
