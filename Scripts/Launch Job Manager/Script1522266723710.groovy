...
WebUI.setText(findTestObject('FSM1/Launch Application/Page_JClient/input_gwt-TextBox GKH2EKQBNHC'), findTestData('Pre Production Environment/UandP').getValue(
        3, 1))

WebUI.setText(findTestObject('FSM1/Launch Application/Page_JClient/input_gwt-PasswordTextBox GKH2'), findTestData('Pre Production Environment/UandP').getValue(
        4, 1))
