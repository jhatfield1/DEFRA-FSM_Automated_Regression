...
WebUI.verifyElementPresent(findTestObject('FSM1/Complete PMM Inspection/PMM Check Results/Page_JM Control Centre/div_Attachments_PMR03A - Produ'), 
    5)

WebUI.verifyElementPresent(findTestObject('FSM1/Complete PMM Inspection/PMM Check Results/Page_JM Control Centre/div_Attachments_PMR06 - Summar'), 
    5)
