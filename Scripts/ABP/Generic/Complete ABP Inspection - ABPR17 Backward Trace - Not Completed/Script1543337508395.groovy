...
'Release 22 - FP-843'
WebUI.verifyElementPresent(findTestObject('FSM1/Release22/Page_JClient/div_Name of Operator_17'), 2)

'Release 22 - FP-843'
WebUI.verifyElementPresent(findTestObject('FSM1/Release22/Page_JClient/div_Name of Operator_17_1'), 2)
...
WebUI.setText(findTestObject('FSM1/Complete ABP Inspection/ABPR17 Backward Trace/Page_JClient/input_Name of Operator_gwt-Tex'), 
    'Test automation')
