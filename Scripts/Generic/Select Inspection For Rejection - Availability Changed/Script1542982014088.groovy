...
WebUI.selectOptionByValue(findTestObject('Object Repository/FSM1/Reject Inspection/Page_JClient/select_Availability ChangedBio'), 
    findTestData('Pre Production/ABP/Rejection - Availability Changed').getValue(1, 1), true)

not_run: WebUI.selectOptionByValue(findTestObject('Object Repository/FSM1/Reject Inspection/Page_JClient/select_Availability ChangedBio'), 
    'BIOSECURITY', true)
